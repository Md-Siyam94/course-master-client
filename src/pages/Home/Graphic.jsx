...
const Graphic = () => {
    ...
    return (
        <div className="relative  bg-[#ffffff]  py-24">
            ...
            <div className="max-w-screen-2xl px-4 lg:flex gap-10 items-center mx-auto">
                <img className="border-8 border-base-300 lg:ml-16 rounded-lg" src="https://i.ibb.co/TMChCC8f/image.png" alt="tutor image" />
                <div>
                    {/* section heading */}
                    <div className="flex flex-col items-start pt-6 text-center">
            ...
            <img className="absolute top-32 md:top-62 lg:top-64" src="https://i.ibb.co/gLLW0rzX/content-shape-1.png" alt="" />
